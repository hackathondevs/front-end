  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(children: [
        Padding(
          padding:
              EdgeInsets.only(bottom: 8.h, top: 34.h, left: 16.w, right: 16.w),
          child: Row(
              ...
              Row(
                ...
                children: [
                  InkWell(
                      ...
                      child: SvgPicture.asset("assets/btn_kbsjourney.svg")),
                  InkWell(
                      onTap: () {
                        context.goNamed(RouteName.kbsCampaignPage);
                      },
                      child: SvgPicture.asset("assets/btn_kbscampaign.svg")),
                  InkWell(
                      onTap: () {
                        context.goNamed(RouteName.kbsMapsPage);
                      },
                      child: SvgPicture.asset("assets/btn_kbsmaps.svg")),
                ],
              ),
              SizedBox(
                height: 8.h,
                ...
                child: InkWell(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsets.only(top: 11.h, left: 11.w, right: 11.w),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Row(
